    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          {/* Reach Us */}
          <div>
            <h4 className="font-display font-semibold text-lg sm:text-xl mb-4 sm:mb-6">Reach Us</h4>
            <div className="mb-4 sm:mb-6">
              <div className="aspect-video bg-background/10 rounded-lg flex items-center justify-center">
                <MapPin className="w-6 h-6 sm:w-8 sm:h-8 text-background/60" />
              </div>
            </div>
            
            <h5 className="font-display font-semibold text-base sm:text-lg mb-3 sm:mb-4">Follow Us</h5>
